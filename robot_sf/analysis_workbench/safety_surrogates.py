...
def constant_velocity_closest_approach(
    ...
    *,
    ...
    if radius_sum_m is None:
        return {"status": "unavailable", "reason": "missing_proxy_radius"}
    ...
    return {
        ...
        "proxy_surface_clearance_at_closest_approach_m": center_distance - radius_sum_m,
