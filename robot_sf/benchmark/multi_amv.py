...
def inter_robot_metrics(
    ...
    *,
    ...
    Returns:
        dict[str, float | bool]: JSON-safe inter-robot metrics.
    """
    ...
    collision_events = np.count_nonzero(min_per_step < settings.collision_distance_m)
    ...
    return {
        ...
        "inter_robot_near_miss_events": float(np.count_nonzero(near_miss_mask)),
