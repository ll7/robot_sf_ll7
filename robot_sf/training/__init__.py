...
_LAZY_EXPORTS = {
    ...
    "CurriculumManifest": ("robot_sf.training.parametric_curriculum",),
    "ParameterDimension": ("robot_sf.training.parametric_curriculum",),
    "ScenarioParameterSpace": ("robot_sf.training.parametric_curriculum",),
    ...
    "build_parametric_curriculum_report": ("robot_sf.training.parametric_curriculum",),
    "build_parameter_space": ("robot_sf.training.parametric_curriculum",),
