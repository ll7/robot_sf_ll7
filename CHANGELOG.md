...
### Added
* Added a Codex-native repository context stack: strengthened `AGENTS.md`, new `code_review.md` benchmark/provenance checklist, `.agent/PLANS.md` planning convention, repo-local context skills under `.agents/skills/`, and AI-facing overview/decision docs under `docs/ai/`.
