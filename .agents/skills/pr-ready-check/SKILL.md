...
- This validation skill verifies relationship documentation but does not create or mutate native
  issue links; those writes belong to the owning issue/publication workflow.
