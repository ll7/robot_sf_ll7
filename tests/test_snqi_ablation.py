"""Tests for SNQI weight-ablation ranking, cross-track gating, and formatter/summary output."""
...
def _episodes_two_groups():
    ...
    """Build two synthetic two-episode groups whose collision weighting flips the ranking."""
    base = {
        "scenario_id": "sc-1",
        "seed": 0,
    }
...
def test_compute_snqi_ablation_rank_shifts():
    """Check that ablating the collisions weight flips the B-first base ranking, giving
    A a rank delta of -1 and B +1.
    """
