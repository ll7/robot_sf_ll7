...
| Topology guidance / primary-route scoring | `revise` after near-parity gating reached non-primary selection and local command influence, but the #2530 corrective smoke still ended `horizon_exhausted` without benchmark-strength improvement. | Test the #2563 `primary_route_reuse_penalty_under_near_parity_alternatives` hypothesis in a paired diagnostic before any benchmark or leaderboard claim. | `revise`; do not promote topology mitigation from the current diagnostic. | [#2530](https://github.com/ll7/robot_sf_ll7/issues/2530), [issue_2530_topology_near_parity_corrective_smoke.md](issue_2530_topology_near_parity_corrective_smoke.md), [#2563](https://github.com/ll7/robot_sf_ll7/issues/2563), [issue_2563_topology_corrective_revision.md](issue_2563_topology_corrective_revision.md) |
