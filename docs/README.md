...
* **[Issue #2468 Adversarial Scenario Generation Roadmap (2026-06-07)](./context/issue_2468_adversarial_generation_roadmap.md)** - Cross-method roadmap for bounded search, RL adversaries, diffusion/generative manifests, learned proposal models, and LLM-to-structured-manifest assistants, with common controls, validity gates, and a schema/validator first spike
