...
| --- | --- | --- | --- | --- | --- |
| Topology selection scoring | #2530 | `revise` | [issue_2530_topology_near_parity_corrective_smoke.md](issue_2530_topology_near_parity_corrective_smoke.md) | Run a paired or broadened diagnostic that separates hypothesis availability, command arbitration, route-progress accounting, and near-parity parameterization while keeping the gate diagnostic-only. | Stop treating the gate as benchmark improvement evidence until it improves route progress, success, or mechanism evidence beyond the single #2518/#2530 slice. |
