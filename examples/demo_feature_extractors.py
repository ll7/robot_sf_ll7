...
def main():
    ...
    custom_mlp = create_feature_extractor_config(
        "mlp",
        ray_hidden_dims=[512, 256, 128],
        drive_hidden_dims=[128, 64],
        dropout_rate=0.2
    )
    ...
    print(f"Custom Attention config: {custom_attention.extractor_type.value} with params {custom_attention.params}")
