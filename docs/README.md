...
* **[Issue #642 Social-Navigation-PyEnvs Source Harness Probe](./context/issue_642_social_navigation_pyenvs_source_harness_probe.md)** - Fail-fast Gymnasium-native source-harness probe showing simulator-core and ORCA viability, with bounded `socialforce` and NumPy 2 blockers before wrapper work
