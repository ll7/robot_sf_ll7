...
* **[Issue #649 Social-Navigation-PyEnvs ORCA Parity Note](./context/issue_649_social_navigation_pyenvs_orca_parity.md)** - Same-snapshot upstream-versus-wrapper parity probe showing a material self-velocity contract mismatch in the current ORCA adapter before downstream unicycle projection
