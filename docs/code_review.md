...
reads the frozen #5579 body text alone, note that the issue body is amended to
state the adapter-only interpretation inline; the durable in-repo reading is
this section plus issue #6828.
