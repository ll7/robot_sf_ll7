...
| [#2662](https://github.com/ll7/robot_sf_ll7/issues/2662) signal-state promotion contract | `044b2c58` (`#2703`) | `docs/context/issue_2662_signal_state_promotion_contract.md`, `robot_sf/benchmark/map_runner/__init__.py`, `configs/benchmarks/signalized_pedestrian_crossing_issue_2474.yaml` | Schema/trace contract | Proxy rows are diagnostic; observable rows need future runtime contract. |
