...
class JSONLPlaybackLoader:
    ...
    def _deserialize_state(self, state_dict: Dict[str, Any], timestep: int = 0) -> VisualizableSimState:
    ...
    def load_single_episode(self, file_path: Union[str, Path]) -> Tuple[PlaybackEpisode, MapDefinition]:
    ...
    def load_directory(self, directory: Union[str, Path]) -> BatchPlayback:
        ...
        logger.info(f"Loaded {len(episodes)} episodes with {total_steps} total steps from {directory}")
