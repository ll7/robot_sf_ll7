...
- Campaign root: `/home/luttkule/git/robot_sf_ll7/output/benchmarks/camera_ready/issue1454-s10-fixed-h100`
...
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| goal | goal | differential_drive | ok | 480 | 0.0063 | 0.2396 | -0.18382529659002314 | 0 | 161.0327 | 2.9808 |
| orca | orca | differential_drive | ok | 480 | 0.1812 | 0.0604 | -0.24968011795222342 | 0 | 247.8762 | 1.9365 |
| ppo | ppo | differential_drive | ok | 480 | 0.2250 | 0.1229 | -0.32800937778762 | 0 | 342.7629 | 1.4004 |
| prediction_planner | prediction_planner | differential_drive | ok | 480 | 0.0625 | 0.2229 | -0.20758021243869815 | 0 | 1341.0938 | 0.3579 |
| sacadrl | sacadrl | differential_drive | ok | 480 | 0.0104 | 0.3792 | -0.31109777026858937 | 0 | 270.6134 | 1.7737 |
| social_force | social_force | differential_drive | ok | 480 | 0.0000 | 0.2250 | -0.8703832943938095 | 0 | 185.4653 | 2.5881 |
| socnav_bench | socnav_bench | differential_drive | unknown | 0 | 0.0000 | 0.0000 | nan | 0 | 0.0108 | 0.0000 |
| socnav_sampling | socnav_sampling | differential_drive | ok | 480 | 0.1604 | 0.4792 | -0.19233527518684682 | 0 | 168.5053 | 2.8486 |

## Runtime Hotspots

| planner | runtime(s) | wall_time_mean(s) | wall_time_p95(s) |
|---|---:|---:|---:|
| prediction_planner (differential_drive) | 1341.0938 | 2.7595 | 3.2821 |
| ppo (differential_drive) | 342.7629 | 0.6779 | 0.9086 |
| sacadrl (differential_drive) | 270.6134 | 0.5274 | 0.7846 |

- `prediction_planner` (differential_drive) top slow scenarios:
  - `classic_realworld_double_bottleneck_high` mean=3.3435s p95=3.3775s (episodes=10)
  - `classic_t_intersection_low` mean=3.3153s p95=3.4901s (episodes=10)
  - `classic_t_intersection_medium` mean=3.3014s p95=3.3521s (episodes=10)
- `ppo` (differential_drive) top slow scenarios:
  - `classic_realworld_double_bottleneck_high` mean=0.9602s p95=1.1966s (episodes=10)
  - `classic_t_intersection_medium` mean=0.9476s p95=1.1657s (episodes=10)
  - `classic_t_intersection_low` mean=0.9178s p95=0.9627s (episodes=10)
- `sacadrl` (differential_drive) top slow scenarios:
  - `classic_realworld_double_bottleneck_high` mean=0.7950s p95=0.8216s (episodes=10)
  - `classic_t_intersection_low` mean=0.7362s p95=0.7850s (episodes=10)
  - `classic_t_intersection_medium` mean=0.7328s p95=0.7808s (episodes=10)
