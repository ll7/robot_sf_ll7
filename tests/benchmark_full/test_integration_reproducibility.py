"""Accelerated integration test for deterministic episode ordering + hash.
...
def _run_minimal_benchmark(
    ...
    """Execute a minimal benchmark run and return ordered IDs + scenario hash."""
...
def test_reproducibility_same_seed(
    ...
    def _timeout_handler(signum, frame):  # pragma: no cover - timeout path rarely triggered
        """Raise a timeout error when the hard alarm triggers."""
        raise TimeoutError(
