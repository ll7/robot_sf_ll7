...
ENTRY_POINT_SURFACES: tuple[EntryPointSpec, ...] = (
    EntryPointSpec(
        ...
        file_path="robot_sf/benchmark/forecast/forecast_metrics.py",
    ...
    EntryPointSpec(
        ...
        file_path="robot_sf/benchmark/forecast/forecast_calibration_report.py",
    ...
    EntryPointSpec(
        ...
        file_path="robot_sf/benchmark/forecast/forecast_conformal_pilot.py",
    ...
    EntryPointSpec(
        ...
        file_path="robot_sf/benchmark/forecast/forecast_dataset_recorder.py",
        required_symbols=(
    ...
    EntryPointSpec(
        ...
        file_path="robot_sf/benchmark/forecast/forecast_batch.py",
    ...
    EntryPointSpec(
        ...
        file_path="robot_sf/benchmark/forecast/forecast_baseline_comparison.py",
    ...
    EntryPointSpec(
        ...
        module="robot_sf.benchmark.forecast.forecast_heavy_model_adapter",
        file_path="robot_sf/benchmark/forecast/forecast_heavy_model_adapter.py",
        required_symbols=(
