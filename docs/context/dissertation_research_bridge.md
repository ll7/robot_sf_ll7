...
| Signalized crossings | Documents a limitation around right-of-way and traffic-signal semantics. | `future validation improvement`; `future paper direction` | #2799 adds simulator-backed denominator/exclusion evidence for explicit planner-observable signal rows, but no legality, forced-waiting, traffic-signal-realism, or planner reasoning claim. | Extend the #2799 denominator smoke into comparison-ready signalized scenarios with validated zone/legality trace fields and predeclared baselines before any ranking or compliance wording. See [issue_2474_signalized_crossing_benchmark.md](issue_2474_signalized_crossing_benchmark.md), [issue_2564_signal_state_proxy_smoke.md](issue_2564_signal_state_proxy_smoke.md), and [issue_2799 evidence](evidence/issue_2799_signalized_runtime/README.md). |
