...
"""
import logging
from pysocialforce.map_osm_converter import extract_buildings_as_obstacle, add_scale_bar_to_root, save_root_as_svg
logging.basicConfig(level=logging.DEBUG)

# Extract the buildings from the map and save them to a new SVG file
root = extract_buildings_as_obstacle(
    "maps/osm_maps/map3_1350.svg",
    map_scale_factor=1350)
