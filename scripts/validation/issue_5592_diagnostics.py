    ...
    *,
    ...
    lines.extend(
        [
            ...
            "     must be in [0, 1], and eligible execution metadata must declare",
            "     status=ok and planner_kinematics.execution_mode as native, adapter,",
            "     or mixed; readiness_status, when present, must use the same set;",
            "     availability_status must be available when present.",
