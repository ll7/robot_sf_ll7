...
def main() -> int:
    ...
    route = None
    if args.route_id or args.route_start or args.route_end or args.route_provenance_id:
        if not (args.route_id and args.route_start and args.route_end and args.route_provenance_id):
