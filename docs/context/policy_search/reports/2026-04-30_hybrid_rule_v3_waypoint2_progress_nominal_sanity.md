# Candidate Report: hybrid_rule_v3_waypoint2_progress (nominal_sanity)
...
- Summary JSON: `output/policy_search/hybrid_rule_v3_waypoint2_progress_nominal/summary.json`
...
|---:|---:|---:|---:|---:|---:|
| 18 | 0.2778 | 0.0556 | 0.1111 | 3.8532 | 1.7492 |
