...
| `brne` | `docs/context/issue_6464_brne_corridor_diagnostic.md`, `docs/context/issue_5318_brne_integration_decision.md`, `docs/context/issue_5311_brne_source_smoke.md` | Bounded corridor diagnostic completed: pinned native BRNE core execution through the Robot SF adapter was exact and non-degenerate on 3/3 seeds with 0/3 goal-reaching; no corridor violations or fallback/degraded rows. This is diagnostic evidence only, not a benchmark result. | Explain or revise the zero-goal-reaching behavior before proposing any broader or ranked campaign. | Follow up in [#6923](https://github.com/ll7/robot_sf_ll7/issues/6923); retain fail-closed fallback/runtime provenance, native-core-via-adapter labeling, and the corridor-only scope. |
