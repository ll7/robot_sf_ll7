...
3. **`reproduced`**
   - **Definition**: An independent execution of the documented commands on the release bundle regenerates the headline benchmark tables and metrics within a specified numeric tolerance.
   - **Requirements**:
