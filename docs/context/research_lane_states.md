...
| --- | --- | --- | --- | --- | --- |
| Topology selection scoring | #2518 | `diagnostic_signal` | [issue_2518_topology_near_parity_gate.md](issue_2518_topology_near_parity_gate.md) | Run a broader diagnostic sweep or benchmark-facing experiment with the accepted near-parity gate still labeled diagnostic-only. | Stop treating the gate as benchmark improvement evidence until it improves route progress, success, or mechanism evidence beyond the single #2518 slice. |
