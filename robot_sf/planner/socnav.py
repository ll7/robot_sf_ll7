...
def __getattr__(name: str) -> Any:
    """Resolve extracted SACADRL symbols without importing the family eagerly.

    Returns:
        Any: Requested symbol from the extracted SACADRL family module.
    """
    if name not in _SACADRL_LAZY_EXPORTS:
