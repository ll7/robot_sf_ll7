...
| `evidence_pointer` | Pinned packet `docs/context/evidence/issue_3213_predictive_nontransfer_confirming_eval_2026-07-08/README.md` (durable campaign-bundle provenance for this confirming-eval plateau; issue [#4879](https://github.com/ll7/robot_sf_ll7/issues/4879)); source grid `docs/context/evidence/issue_3213_authority_sweep/robust_grid.json` |
