...
* **[Issue #1444 CARLA Coordinate Alignment Contract](./context/issue_1444_carla_coordinate_alignment_contract.md)** - Conservative replay-mode taxonomy and projection tolerances required before any Robot-SF/CARLA metric parity claim
