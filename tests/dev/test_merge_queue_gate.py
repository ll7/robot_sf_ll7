...
def test_rollup_rejects_completed_gate_without_started_at() -> None:
    """A completedAt-only failure cannot hide behind older green gate evidence."""
    rollup = [
        {
            "__typename": "CheckRun",
            "name": "merge-queue-gate",
            "workflowName": "Merge Queue Gate",
            "startedAt": "2026-07-25T12:00:00Z",
            "completedAt": "2026-07-25T12:01:00Z",
            "status": "COMPLETED",
            "conclusion": "SUCCESS",
        },
        {
