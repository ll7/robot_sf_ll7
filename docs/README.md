...
* **[Issue #1436 CI Reproducibility and Flaky Statistical Acceptance](./context/issue_1436_reproducibility_flaky_acceptance.md)** - Canonical validation lanes, deterministic vs stochastic failure classification, and explicit CI rerun rules
