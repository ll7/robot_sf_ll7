...
def test_guidance_soft_contains_core_suggestions():
    """Verify soft breach guidance contains core scenario and sampling recommendations."""
...
def test_guidance_hard_contains_hard_phrase():
    """Verify hard breach guidance warns about timeout risks and scenario complexity."""
...
def test_guidance_large_duration_prioritizes_matrix_and_horizon():
    """Verify long-duration breaches prioritize scenario matrix and horizon recommendations."""
