...
Outcome-row identity is explicit as the composite `(arm, search_seed, candidate_id)`; `candidate_id`
alone is not globally unique across the equal-budget arms and search seeds.
