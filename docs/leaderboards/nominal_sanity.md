...
| --- | --- | ---: | ---: | ---: | --- | --- | --- | --- | --- | --- | --- |
| `ppo_issue791_best_v1` | `policy_search:nominal_sanity` | `0.2778` | `0.0000` | `0.2222` | `10/18` | `3.7136` | `not_recorded` | `policy_search_nominal_sanity` | [`docs/context/policy_search/reports/2026-05-05_ppo_issue791_best_v1_nominal_sanity.md`](../context/policy_search/reports/2026-05-05_ppo_issue791_best_v1_nominal_sanity.md) | `revise` | Learned-only nominal-sanity row from that pass, but still limited by low-progress timeouts and intrusive near misses. |
