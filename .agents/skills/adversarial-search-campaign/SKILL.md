...
description: Analyze adversarial route/search campaigns with canonical commands, expected artifacts, status
...
1. Record route sampler, scenario split, seed schedule, failure archive, and fallback/degraded counts.
