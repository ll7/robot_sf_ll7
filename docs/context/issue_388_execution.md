...
- Added SVG filename provenance to invalid and repair warnings so future triage points at the offending map file immediately.
...
- Added a log-capture regression test that checks the warning text includes the source SVG filename.
