...
def _validate_campaign_config(cfg: CampaignConfig) -> None:  # noqa: C901, PLR0912, PLR0915
    ...
    # mirroring #4970's checkpoint-provenance fail-closed spirit.  A backfilled or unknown
    # record remains useful auditability metadata, but cannot satisfy this strict new-arm gate.
