...
- Campaign root: `/home/luttkule/git/robot_sf_ll7.worktrees/origin-1023-validate-scenario-h500-bench/output/benchmarks/issue_1023/issue1023_scenario_horizons_h500_local_2026-05-06`
...
|---|---|---|---:|---:|---:|---:|---:|---:|---:|
| goal | goal | ok | 144 | 0.0556 | 0.6181 | -0.1904378873091616 | 0 | 45.0499 | 3.1965 |
| orca | orca | ok | 144 | 0.7569 | 0.1667 | -0.25134526846413413 | 0 | 71.7924 | 2.0058 |
| ppo | ppo | ok | 144 | 0.8056 | 0.1667 | -0.20744673065513033 | 0 | 140.0520 | 1.0282 |
| prediction_planner | prediction_planner | ok | 144 | 0.4931 | 0.4514 | -0.14075642225341856 | 0 | 396.7669 | 0.3629 |
| sacadrl | sacadrl | ok | 144 | 0.0833 | 0.6667 | -0.2725885642962835 | 0 | 57.7939 | 2.4916 |
| social_force | social_force | ok | 144 | 0.0139 | 0.3819 | -0.9537106074382992 | 0 | 75.5148 | 1.9069 |
| socnav_sampling | socnav_sampling | ok | 144 | 0.4028 | 0.5972 | -0.08483026461988694 | 0 | 29.2304 | 4.9264 |

## Runtime Hotspots

| planner | runtime(s) | wall_time_mean(s) | wall_time_p95(s) |
|---|---:|---:|---:|
| prediction_planner | 396.7669 | 5.4768 | 8.9590 |
| ppo | 140.0520 | 0.9491 | 1.4390 |
| social_force | 75.5148 | 1.0196 | 2.6097 |

- `prediction_planner` top slow scenarios:
  - `classic_realworld_double_bottleneck_high` mean=12.9082s p95=15.1615s (episodes=3)
  - `classic_station_platform_medium` mean=10.1841s p95=22.3765s (episodes=3)
  - `francis2023_parallel_traffic` mean=8.9845s p95=9.1780s (episodes=3)
- `ppo` top slow scenarios:
  - `classic_station_platform_medium` mean=3.0830s p95=3.3384s (episodes=3)
  - `classic_bottleneck_low` mean=2.9436s p95=7.0830s (episodes=3)
  - `classic_realworld_double_bottleneck_high` mean=1.7334s p95=2.1931s (episodes=3)
- `social_force` top slow scenarios:
  - `classic_bottleneck_low` mean=5.1423s p95=7.2540s (episodes=3)
  - `classic_realworld_double_bottleneck_high` mean=3.4211s p95=3.4431s (episodes=3)
  - `classic_bottleneck_high` mean=2.6274s p95=3.1958s (episodes=3)
