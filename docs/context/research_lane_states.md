...
| --- | --- | --- | --- | --- | --- |
| Topology selection scoring | #2704 | `revise` | [issue_2704_progress_gated_topology_successor.md](issue_2704_progress_gated_topology_successor.md) | Synthesize the topology lane before opening another local selector variant; any successor should name a different mechanism and a metric beyond primary-route selection counts. | Stop treating the progress-gated reselection candidate as benchmark improvement evidence; do not rerun `topology_guided_hybrid_rule_v0_progress_gated_reselection` unchanged on the canonical h160 double-bottleneck slice. |
