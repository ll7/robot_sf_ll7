"""Run the stage-1 issue-739 PPO ablation matrix and summarize the results."""
...
DEFAULT_CONFIGS = (
    Path("configs/training/ppo/ablations/expert_ppo_issue_739_stage1_baseline.yaml"),
    Path("configs/training/ppo/ablations/expert_ppo_issue_739_stage1_reward_core.yaml"),
    Path("configs/training/ppo/ablations/expert_ppo_issue_739_stage1_obs_grid_goal.yaml"),
    Path("configs/training/ppo/ablations/expert_ppo_issue_739_stage1_obs_selective.yaml"),
)
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("output/validation/issue_739_stage1_ablations/latest"),
...
def main(argv: list[str] | None = None) -> int:
    """Run the configured stage-1 ablations and write summary artifacts."""
