...
- Mapping hash: `2321f90648b9`

## Coverage Overlap Matrix

| Robot SF Family | Scenario Count | Alyassi Category | Overlap |
|---|---:|---|---|
| bottleneck | 1 | unmapped | amv_extension |
| doorway | 1 | unmapped | amv_extension |
| empty_map_8_directions | 1 | unmapped | amv_extension |
| single_ped_crossing_orthogonal | 1 | unmapped | amv_extension |
