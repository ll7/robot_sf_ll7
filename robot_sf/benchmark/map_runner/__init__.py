"""Canonical map-based benchmark runner package.

The package root preserves the historical ``robot_sf.benchmark.map_runner`` batch-entry API while
the extracted helpers live in sibling modules. The old flat helper paths remain identity-
preserving compatibility shims until their named removal follow-up.
"""
