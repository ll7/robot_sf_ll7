...
7. Worktree hygiene:
   ...
   - If this worktree owns an issue or PR handoff, verify the native relationship readback before
     teardown using `docs/context/issue_relationships.md`; preserve
