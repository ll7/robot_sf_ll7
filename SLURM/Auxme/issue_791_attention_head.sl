...
#SBATCH --gres=gpu:1
#SBATCH --output=output/slurm/%j-issue791-attention-head.out
...
if [[ -z "${TRAIN_CONFIG}" ]]; then
  ...
  echo "[issue791] Example: ISSUE791_TRAIN_CONFIG=configs/training/ppo/ablations/expert_ppo_issue_791_attention_head_promotion_10m_env22.yaml sbatch $0" >&2
  exit 2
fi
