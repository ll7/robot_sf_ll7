...
| Issue #2903 | closed | Horizon/timestep denominator health | Historical denominator-health audit for the Issue #2837 ablation. Superseded by Issue #2937 after the proposed fixture gaps were repaired. Bundle in `docs/context/evidence/issue_2903_horizon_denominator_health_2026-06-16/`. |
