...
| --- | --- | --- | --- | --- | --- |
| Topology selection scoring | #2621 | `revise` | [issue_2621_topology_revision_hypothesis.md](issue_2621_topology_revision_hypothesis.md) | Run the paired `topology_guided_hybrid_rule_v0_reuse_penalty` diagnostic against `topology_guided_hybrid_rule_v0`, preserving the #2540 reuse-penalty fields and #2530 corrective-behavior fields. | Stop treating the gate as benchmark improvement evidence until the paired reuse-penalty diagnostic improves route progress, success, or mechanism evidence beyond the single #2518/#2530 slice. |
