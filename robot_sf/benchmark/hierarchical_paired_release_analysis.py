...
class MatchedCell:
    ...
    Attributes:
        ...
        exposure_a/exposure_b: Interaction-opportunity exposure (time, distance,
            or opportunity count) over which near-miss counts arose.
    """
...
def _protocol_conformance(
    *,
    ...
    delivered = {
        ...
        "normalized_near_miss_exposure": True,
