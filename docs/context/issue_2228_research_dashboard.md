...
| Planner mechanism transfer | Protocol exists for separating slice-local mechanisms from transferable mechanisms; static recentering is `slice_local`, and the topology near-parity lane is `revise` after #2530. | `diagnostic`/`negative` for mitigation | Static recentering lacks transfer evidence, and topology has not passed a corrective-behavior gate. Neither lane supports transfer or mitigation promotion. | Keep topology transfer or benchmark claims frozen until #2540 or a narrower #2563-derived diagnostic shows progress beyond the single canonical slice. | [issue_2232_planner_mechanism_transfer_benchmark.md](issue_2232_planner_mechanism_transfer_benchmark.md), [issue_2221_static_recenter_transfer.md](issue_2221_static_recenter_transfer.md), [issue_2530_topology_near_parity_corrective_smoke.md](issue_2530_topology_near_parity_corrective_smoke.md), [issue_2563_topology_corrective_revision.md](issue_2563_topology_corrective_revision.md), [issue #2540](https://github.com/ll7/robot_sf_ll7/issues/2540) |
