...
rtk bash -lc 'test -f docs/context/issue_1057_semantic_blocker_audit.md'
rtk bash -lc 'test -f docs/context/issue_1058_h500_paper_language.md'
...
rtk bash -lc 'test -f docs/context/issue_1054_planner_readiness_fallback_audit.md'
rtk bash -lc 'test -f docs/context/issue_1073_empirical_expansion_gate_2026_06_08.md'
